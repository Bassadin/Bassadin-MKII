	...
	<section class="w-full">
		...
		<ul class="m-elements">
			...
			<li>
				...
				<strong>Standardvertragsklauseln (Gewährleistung Datenschutzniveau
			...
			<li>
				...
				<strong>Dienstanbieter:</strong> Twitter International Company,
				One Cumberland Place, Fenian Street, Dublin 2 D02 AX07, Irland,
				Mutterunternehmen: Twitter Inc., 1355 Market Street, Suite 900,
				...
				<a
					...
					target="_blank"
				>https://twitter.com/privacy</a>, (Settings:
				<a
		...
		<ul class="m-elements">
			<li>
				...
				technischen Umgebung notwendig sind;
		...
		<ul>
			<li>
				<strong>Widerspruchsrecht: Sie haben das Recht, aus Gründen, die
			...
			<li>
				<strong>Recht auf Löschung und Einschränkung der
					Verarbeitung:</strong>
